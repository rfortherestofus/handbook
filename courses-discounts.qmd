...
If users have submitted enough information to verify their status, you can add them to an already existing coupon. There are two coupons:

1. [STUDENT](https://rfortherestofus.com/cp/simple-commerce/coupons/9152e6de-1152-445f-89a6-c304a5c11a63/edit) (for students)

1. [PPP50](https://rfortherestofus.com/cp/simple-commerce/coupons/0a8c4cc0-7055-4b44-a6a8-f791c680f08e/edit) (for those in low-income locations)

For users who already have an account on the R for the Rest of Us site, please add them as follows:

<div class="muse-video-player" data-video="4x3YxGp" data-links="0" data-logo="0" data-title="0" data-width="100%"></div><script src="https://muse.ai/static/js/embed-player.min.js"></script>
...
Thanks for reaching out a the discount on R for the Rest of Us courses for students. You can use the coupon code STUDENT on checkout to receive a 50% discount on any course. If you have any trouble using it, please just let us know.
...
Thanks for reaching out a the discount on R for the Rest of Us courses for those in low-income locations. You can use the coupon code PPP50 on checkout to receive a 50% discount on any course. If you have any trouble using it, please just let us know.
