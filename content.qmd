...
1. When there is a new blog post, David adds the information about it (link to the blog post, Descript link, and email text) to [this website](https://blogcontentinfo.netlify.app/).
