...
We use three tools to manage each project:
...
We should email clients each week to give them a quick overall update on progress and see if they have any questions. Please make sure to cc David on these weekly updates. 