...
- David shares [rfortherestofus package](https://github.com/rfortherestofus/rfortherestofus) to be used for the custom xaringan template
- Instructor develops slides
- David approves slides

## Recording

- David sets up shared Google Drive folder for raw videos
...
- David edits videos
- David has transcripts created for all videos
