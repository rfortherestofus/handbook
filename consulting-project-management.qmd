...
When creating a new project in Linear, also set the **start date**, **target date**, and **project status** to In Progress. Also set a **project lead**, which will set a reminder every Friday at 8am Pacific for them to post an update about how things are going with the project. When posting this update, please also post about the project health using the built-in tool for that. 
